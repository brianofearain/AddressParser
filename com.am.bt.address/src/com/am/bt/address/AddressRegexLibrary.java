...
import static com.bttw.address.RegexLibrary.ADDR_UNIT;
import static com.bttw.address.RegexLibrary.COUNTIES;
import static com.bttw.address.RegexLibrary.DIRECTIONS;
import static com.bttw.address.RegexLibrary.ORDINAL_ALL;
import static com.bttw.address.RegexLibrary.STREET_DESIGNATOR;
import static com.bttw.address.RegexLibrary.TXT_NUM_0_9;
import static com.bttw.address.RegexLibrary.TXT_NUM_10_19;
import static com.bttw.address.RegexLibrary.TXT_ORDINAL_0_19;
import static com.bttw.address.Utils.compile;

import com.bttw.address.Utils.NamedGroupPattern;
...
class AddressRegexLibrary{
  ...
  private static final String NOT_STATE_OR_ZIP = "(?![^,]*\\W+(?:\\b(?:"+COUNTIES+")\\b(?:\\W*$|(?:"+ZIP+")\\W*$))|(?:\\b(?:"+ZIP+")\\b\\W*$))";
